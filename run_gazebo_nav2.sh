...
echo "[run_gazebo_nav2] Using world: $ACTIVE_WORLD"
...
export AMR_NAV2_PARAMS_PATH="${AMR_NAV2_PARAMS_PATH:-$ROOT_DIR/ros2_ws/src/kolestel_rover_description/config/nav2_params.yaml}"
